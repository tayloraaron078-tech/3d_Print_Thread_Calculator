...
class ThreadCalculatorWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        # FIX: single container with its object name set before use
        container = QWidget()
        ...
        content_layout.addWidget(self._build_left_column(), 5, Qt.AlignTop)
        content_layout.addWidget(self._build_right_column(), 6, Qt.AlignTop)
        outer_layout.addLayout(content_layout, 1)

        # FIX: set scroll_area as the single central widget
    ...
    def _build_left_column(self) -> QWidget:
        ...
        # FIX: each button created exactly once with its object name set once
        ...
        # FIX: each card added to the layout exactly once
